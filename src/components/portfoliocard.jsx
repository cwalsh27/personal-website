...
function PortfolioCard (props) {
    return (
        ...
        className="h-[75%] w-[30%] mx-20 rounded-2xl shadow-2xl bg-gradient-to-br from-white to-slate-200 flex justify-between flex-col hover:scale-105" style={{flex: "0 0 auto"}}>
            <div>
