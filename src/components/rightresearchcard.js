...
function RightResearchCard(props) {
    ...
    return(
        <div id={props.idFix} className='h-[80vh] w-full bg-background flex justify-center items-center'>
            <div className='w-[85%] h-[90%] rounded-2xl shadow-2xl flex justify-between items-center bg-gradient-to-br from-white to-slate-200'>
